...
abstract contract Ownable is Context {
    ...
    function setMultisigOwnership(address newMultisig)
        public
        virtual
        onlyOwner
    {
...
contract BabyFlokiDoge is Context, IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount, bool[2] memory isSale_isSniper)
        private
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        rVector memory my_rVector;
        {
            (
                ...
                uint256 tLiquidity,
                uint256 tMarketing
            ) = _getTValues(tAmount, isSale_isSniper);
    ...
    */
    ...
    function _getTValues(uint256 tAmount, bool[2] memory isSale_isSniper)
        private
        view
        returns (
            uint256,
    ...
    function calculateTaxFee(uint256 _amount, bool isSale)
        private
        view
        returns (uint256)
    {
    ...
    function calculateMarketingFee(uint256 _amount, bool isSniper)
        private
        view
        returns (uint256)
    {
