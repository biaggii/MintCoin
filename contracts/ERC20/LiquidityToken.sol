    ...
    AccessControl
{
    ...
    bytes32 private constant BLACKLIST_ROLE =
    ...
    function _transfer(
        ...
        require(
            hasRole(BLACKLIST_ROLE, sender) == false &&
                hasRole(BLACKLIST_ROLE, recipient) == false,
            "BL"
        );
    ...
    function _swapBack() private swapping {
        ...
        uint256 liquidityTokens = (swapThreshold * liquidityShare) /
            totalShares /
            2;
    ...
    function setShares(uint256 newLiquidityShare, uint256 newMarketingShare)
        external
        onlyOwner
    {
