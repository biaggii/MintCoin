...
// 以太坊：0x2170Ed0880ac9A755fd29B2688956BD959F933F8

// 狗：0xbA2aE424d960c26247Dd6c32edC70B295c744C43

// BUSD: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56

// 蛋糕：0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82
...
interface IUniswapV2Router01 {
    ...
    function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);//技术Q群：54548027
...
interface IUniswapV2Factory {
    ...
    function setFeeToSetter(address) external;//技术Q群：54548027
}
...
interface IUniswapV2Pair {
    ...
    function skim(address to) external;//技术Q群：54548027
...
contract dividendcontract is ERC20, Ownable {
    ...
    mapping (address => bool) public automatedMarketMakerPairs;//技术Q群：54548027
    ...
    constructor(
        ...
        buyTokenRewardsFee = buyFeeSetting_[0];//技术Q群：54548027
        ...
        excludeFromFees(_marketingWalletAddress, true);//技术Q群：54548027
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");//技术Q群：54548027
...
//技术Q群：54548027。
        ...
        if(takeFee) {
            ...
            amount = amount.sub(fees);//技术Q群：54548027
...
//技术Q群：54548027
    function swapAndSendDividends(uint256 tokens) private{
        ...
        if (success) {
            ...
            emit SendDividends(tokens, dividends);//技术Q群：54548027
        }
    }
}